...
public class EventServiceImpl implements EventService {
    ...
    public Event addNewEvent(Event event) {
        ...
        log.info("EventService.addNewEvent: отправьте запрос в базу данных для создания нового события с заголовком={}", event.getTitle());
    ...
    public Event updateEvent(Event event) {
        ...
        log.info("EventService.updateEvent: отправьте запрос в базу данных для создания нового события с заголовком={}", event.getTitle());
