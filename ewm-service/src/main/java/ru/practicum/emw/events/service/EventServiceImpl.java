...
import ru.practicum.emw.events.repository.EventRepository;
...
public class EventServiceImpl implements EventService {
    ...
    public Event addEvent(Event event) {
        ...
        log.info("EventService.addEvent: отправьте запрос в базу данных для создания нового события с title={}", event.getTitle());
    ...
    public Event updateEvent(Event event) {
        ...
        log.info("EventService.updateEvent: отправьте запрос в базу данных для создания нового события с title={}", event.getTitle());
